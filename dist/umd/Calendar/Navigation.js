...
function Navigation(_ref) {
  var activeStartDate = _ref.activeStartDate,
      ...
      _ref$actionAriaLabel = _ref.actionAriaLabel,
      actionAriaLabel = _ref$actionAriaLabel === void 0 ? '' : _ref$actionAriaLabel,
      ...
      views = _ref.views,
      value = _ref.value,
      drillUpAriaLabel = _ref.drillUpAriaLabel,
      drillUpLabel = _ref.drillUpLabel,
      drillDownAriaLabel = _ref.drillDownAriaLabel,
      drillDownLabel = _ref.drillDownLabel;
  ...
  function renderButton() {
    ...
    }, renderLabel(nextActiveStartDate))), drillDownLabel && view === 'month' && drillDownLabel, drillUpLabel && view !== 'month' && drillUpLabel);
  }
  ...
  }, renderButton(), prevLabel !== null && /*#__PURE__*/_react["default"].createElement("button", {
    "aria-label": prevAriaLabel,
    className: "".concat(className, "__arrow ").concat(className, "__prev-button"),
    disabled: prevButtonDisabled,
    onClick: onClickPrevious,
    type: "button"
  }, prevLabel), nextLabel !== null && /*#__PURE__*/_react["default"].createElement("button", {
    "aria-label": nextAriaLabel,
    className: "".concat(className, "__arrow ").concat(className, "__next-button"),
    disabled: nextButtonDisabled,
    onClick: onClickNext,
    type: "button"
  }, nextLabel), actionLabel && actionHandler && /*#__PURE__*/_react["default"].createElement("div", {
    className: "".concat(className, "__action-wrapper")
  }, /*#__PURE__*/_react["default"].createElement("button", {
    "aria-label": actionAriaLabel,
    className: "".concat(className, "__action-button"),
...
Navigation.propTypes = {
  ...
  actionAriaLabel: _propTypes["default"].string,
  actionLabel: _propTypes["default"].node,
  actionHandler: _propTypes["default"].func,
  drillUpAriaLabel: _propTypes["default"].string,
  drillUpLabel: _propTypes["default"].node,
  drillDownAriaLabel: _propTypes["default"].string,
  drillDownLabel: _propTypes["default"].node,
